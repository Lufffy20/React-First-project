...
const daysOptions = ["1 Day", "2 Days", "3 Days", "4 Days", "5+ Days", "11 Days"];
const nightsOptions = ["0 Nights", "1 Night", "2 Nights", "3 Nights", "4 Nights", "10 Nights"];
const specialsOptions = ["Best Price Guarantee", "Free Cancellation"];

const ExpandableCheckboxGroup = ({ options, value, onChange, className }) => {
        ...
        <aside className="details-sidebar">
            ...
            <div className="filter-box filter-tour-type">
                ...
                <ExpandableCheckboxGroup
                    ...
                    onChange={(values) => onFilterChange('tourTypes', values)}
            ...
            <div className="filter-box filter-accordion">
                ...
                <div className="filter-duration-container">
                    <div className="filter-duration-column">
                        <h4 className="filter-duration-title">Days</h4>
                        <ExpandableCheckboxGroup
                            options={daysOptions}
                            value={filters.days}
                    ...
                    <div className="filter-duration-column">
                        <h4 className="filter-duration-title">Nights</h4>
                        <ExpandableCheckboxGroup
                            options={nightsOptions}
                            value={filters.nights}
                            onChange={(values) => onFilterChange('nights', values)}
                            className="filter-checkbox-group"
                        />
                    </div>
                </div>
            ...
            <div className="filter-box filter-accordion">
                ...
                {availableLanguages.length > 0 ? (
                    ...
                    <div style={{ padding: '10px 0', color: '#888', fontSize: '14px' }}>No languages currently available</div>
                )}
            </div>
            ...
            <div className="filter-box filter-accordion">
                ...
                <div className="filter-rating-container">
                    <span className="filter-rating-label">Min rating: 0 & Up</span>
                    <Rate
                        allowHalf
